<?php
	...
	if($add){
		...
		$query1 = "UPDATE `export` SET `amount`='$amount',`exportdate`='$datemodified' WHERE title = '$title';";
...
<head>
	...
	<div class="adddisp"  id="imprt">
			...
			<center>
				<div class="items">
					<fieldset>
						<legend>export <?php echo $ititle; ?></legend>
						...
						<a href="index.php"><img src="download.png" alt="" style="top: 40%;"></a>
							<div class="input">
								...
								<br>
								<button type='submit' name="add" value='submit'>Export</button>
